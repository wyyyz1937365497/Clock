...
void showAddAlarmDialog()
{
    ...
    Button level1Btn(dialogX + 20, dialogY + 140, 60, 30, "等级 1", [&selectedLevel]()
                     { selectedLevel = 1; });
    Button level2Btn(dialogX + 90, dialogY + 140, 60, 30, "等级 2", [&selectedLevel]()
                     { selectedLevel = 2; });
    Button level3Btn(dialogX + 160, dialogY + 140, 60, 30, "等级 3", [&selectedLevel]()
                     { selectedLevel = 3; });
                    ...
                    if (!name.empty())
                    {
                        ...
                        try
                        {
                            ...
                            if (!hourInput.getText().empty())
                                hour = stoi(hourInput.getText());
                            if (!minuteInput.getText().empty())
                                minute = stoi(minuteInput.getText());
                            if (!secondInput.getText().empty())
                                second = stoi(secondInput.getText());
